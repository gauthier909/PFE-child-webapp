(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(swUpdate, socketService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChoixCategorieComponent = /** @class */ (function () {
                function ChoixCategorieComponent(gameService, router, categorieService) {
                    this.gameService = gameService;
                    this.router = router;
                    this.categorieService = categorieService;
                    this.cheminImages = [''];
                }
                ChoixCategorieComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getCategories();
                    //console.log(this.categories)
                    this.getCheminImage();
                    this.gameService.currentMessage.subscribe(function (choixCat) { return _this.choixCat = choixCat; });
                };
                ChoixCategorieComponent.prototype.clickChoixCat = function (value) {
                    console.log(value);
                    this.choixCat = value;
                    this.gameService.updateChoix(this.choixCat);
                    this.router.navigateByUrl('/choixHabitude');
                };
                ChoixCategorieComponent.prototype.getCategories = function () {
                    var _this = this;
                    this.categorieService.getCategories().subscribe(function (categories) {
                        ...
                        _this.categories.forEach(function (cat) {
                            ...
                            _this.categorieService.getCheminImageByCategorie(cat.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "")).subscribe(function (chemin) {
                                var vraiChemin = '';
                                for (var i = 0; i < chemin.length; i++) {
                                    vraiChemin += chemin[i];
                                }
                                console.log('vrai chemin:' + vraiChemin);
                                _this.cheminImages.push(vraiChemin);
                                _this.cheminImages.sort();
                                //console.log(this.cheminImages)
                            });
                            _this.cheminImages.shift();
                            console.log(_this.cheminImages);
                        });
                    });
                };
                //retourne un tableau du chemin de la première image de chaque categorie
                ChoixCategorieComponent.prototype.getCheminImage = function () {
                    //console.log(this.categories)
                    /* this.categories.forEach(cat => {
                       console.log(this.categorieService.getCheminImageByCategorie(cat));
                   });*/
                };
                return ChoixCategorieComponent;
            }());
            ChoixCategorieComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_game_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/game.service */ "./src/services/game.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var ChoixHabitudeComponent = /** @class */ (function () {
                function ChoixHabitudeComponent(gameService, router) {
                    this.gameService = gameService;
                    this.router = router;
                    this.indexImage = 0;
                ...
                ChoixHabitudeComponent.prototype.ngOnInit = function () {
                    ...
                    this.indexImage = 0;
                    this.gameService.currentMessage.subscribe(function (choixCat) { return _this.choixCat = choixCat; });
                    this.gameService.getAllImagesByCategorie(this.choixCat.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "")).subscribe(function (images) {
                        _this.tabImagesCategorie = images;
                        console.log(_this.tabImagesCategorie);
                    });
                };
                ChoixHabitudeComponent.prototype.onOui = function () {
            ...
            ChoixHabitudeComponent.ctorParameters = function () { return [
                { type: _services_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var FinPartieComponent = /** @class */ (function () {
                function FinPartieComponent() {
                }
                FinPartieComponent.prototype.ngOnInit = function () {
                };
                return FinPartieComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            LetsPlayComponent.ctorParameters = function () { return [
                { type: _services_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PartieComponent = /** @class */ (function () {
                function PartieComponent(gameService, router, socket) {
                    this.gameService = gameService;
                    this.router = router;
                    this.socket = socket;
                ...
                PartieComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    if (this.socket.message === undefined || this.socket.message.message[0] === undefined || this.socket.message.message.length <= 0) {
                        ...
                        for (var i = 0; i < this.socket.message.message.length; i++) {
                ...
                PartieComponent.prototype.onOui = function () {
                    var nomCurrentImage = this.tabImageJeu[this.indexImage];
                    var choix = {
                ...
                PartieComponent.prototype.onNon = function () {
                    var nomCurrentImage = this.tabImageJeu[this.indexImage];
                    var choix = {
                        nomImage: nomCurrentImage,
                        valeur: 1
                ...
                PartieComponent.prototype.onJsp = function () {
                    var nomCurrentImage = this.tabImageJeu[this.indexImage];
                    var choix = {
                        nomImage: nomCurrentImage,
                        valeur: 2
                ...
                PartieComponent.prototype.insertFiltre = function (commentaire, nom, choix) {
                    //console.log('insertion from component')
                    this.gameService.insertFiltre({ commentaire: commentaire, nom: nom, choix: choix }).subscribe(function (filtre) {
                        console.log('insert filtre');
                    });
                };
                PartieComponent.prototype.switchFiltre = function () {
            ...
            PartieComponent.ctorParameters = function () { return [
                { type: _services_game_service__WEBPACK_IMPORTED_MODULE_2__["GameService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
            ...
            var CategorieService = /** @class */ (function () {
                ...
                CategorieService.prototype.getCategories = function () {
                    this.mesCategories = this.http.get(this.categorieUrl)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log('fetched categorie'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCategorie', [])));
                    return this.mesCategories;
                };
                //retourne le premier chemin d'une categorie de la collection image
                CategorieService.prototype.getCheminImageByCategorie = function (categorie) {
                    var url = this.cheminCategorieUrl + "/" + categorie;
                    this.cheminImageCategorie = this.http.get(url)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log('fetched chemin categorie'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCheminCategorie', [])));
                    return this.cheminImageCategorie;
                };
                CategorieService.prototype.handleError = function (operation, result) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GameService = /** @class */ (function () {
                ...
                GameService.prototype.updateChoix = function (choixCat) {
                    this.choixCat.next(choixCat);
                };
                GameService.prototype.insertFiltre = function (filtre) {
                    //console.log('insert filtre from service')
                    return this.http.post(this.filtreUrl, filtre, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (newFiltre) { return console.log("added filtre w/ id=" + newFiltre._id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addFiltre')));
                };
                GameService.prototype.getAllImagesByCategorie = function (categorie) {
                    var url = this.imageCategorieUrl + "/" + categorie;
                    this.tabImageCategorie = this.http.get(url)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log('fetched chemin image categorie'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCheminImageCategorie', [])));
            ...
            var SocketService = /** @class */ (function () {
                ...
                SocketService.prototype.socketInit = function () {
                    ...
                    this.socket.on("message", function (message) {
                        ...
                        console.log("[SOCKET] Message recu : ", _this.message);
                    });
                };
                /**
